...
const User = () => {
  return (
    <div className='min-w-[100vw] '>
        <div className='text-[#1D2226] h-[68px] min-w-[100vw] bg-[#FFFFFF] pt-[27px] pl-[15px] text-[18px] font-normal'>Account Settings</div>
        ...
        <div className='tetx-[#1D2226] text-[14px] font-normal pl-[20px] pr-[20px] pb-[30px] mt-[30px] '>Lorem Ipsum Dolor Sit Amet, Consetetur Sadipscing Elitr, Sed Diam Nonumy Eirmod Tempor Invidunt Ut Labore Et Dolore Magna Aliquyam Erat, Sed Diam</div>
