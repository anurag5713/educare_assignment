...
const LoginForm = () => {
  ...
  return (
    <div className="pt-[40px] pl-[20px] pr-[20px] ">
      ...
      <p className="text-[18px] font-normal opacity-[0.6] ">
      ...
      <form className="mt-[28px]">
        <label className="relative ">
          ...
          <input
            className="w-[335px] h-[40px] rounded-[6px] border-[1px] border-solid 
        ...
        <label className="realtive">
          <p className="mb-1 text-[0.875rem]  text-[#6C25FF] absolute top-[282px] left-[605px] bg-[#F7F8F9] pl-1 pr-10">
            Password
          </p>
          <input
            className="w-[335px] h-[40px] rounded-[6px] border-[1px] border-solid 
        ...
        <button
          ...
          className="w-[335px] h-[40px] 
            bg-[#CBCBCB] text-[16px] rounded-[6px] mt-[20px] text-[#FFFFFF] "
        >
          Login
        </button>
      </form>
